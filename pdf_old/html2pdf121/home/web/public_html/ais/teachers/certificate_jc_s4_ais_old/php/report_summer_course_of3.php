...
$sstudent="select * from (SELECT count(A.id) total,CONCAT(D.firstname,' ',D.lastname) as student, C.name as room, B.academicyear_id as year, B.id as classroom,G.title,G.description,G.requirements,E.camp_id
from summer_course_enrolls_pri A
left join summer_courses_pri G on (G.id = A.summer_course_id)
...
where md5(A.student_id) ='".$sid."'  group by A.student_id ) a where total > 2
"; //limit 2
...
if($rows==0){
	...
	if($i<10){
		...
		//$nroom=$r['Class_Name'];
		echo '<page orientation="paysage">
		<div  style="padding-top:149mm;  background-image: url(Certificate.jpg);  background-size: contain;">
		<div style="margin: auto;">
		<br>
		...
		<div style="line-height:1; font-family:times; color:black; text-align:left;margin-left:237pt; font-size:12pt"><b>Is awarded to</b> </div>
		 <br>
		<div style="line-height:0.5; font-family:aparabi; font-style:italic; color:black; text-align:left;margin-left:237pt; font-size:43pt"><b>'.$rstudent['student'].'</b></div>
		 <br>';
		echo '<div style="line-height:0.9; font-family:times; color:black; text-align:left;margin-left:237pt; font-size:14pt"><b>for successfully completing three courses or more during the </b></div>
		<br>';
			//'.convertNumber($rstudent['total']).' 
		echo '
		 
		<div style="line-height:1; font-family:times; color:black; text-align:left;margin-left:237pt; font-size:14pt"><b>1st Bina Bangsa School E-Learning Festival Held on 2 - 12 June 2020.</b> </div>	
		</div>';
