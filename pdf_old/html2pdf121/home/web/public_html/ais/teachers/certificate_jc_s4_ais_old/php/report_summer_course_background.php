...
if($rows==0){
	...
	echo '<page orientation="paysage">
		...
		<br>
		<br>';
		echo '<div style="line-height:1; font-family:times; color:black; text-align:center; font-size:16pt"><span style="color: #c0392b ;">for participating</span> in the 1st Bina Bangsa School E-Learning Festival held from 2 - 12 June 2020. </div>	
		<br>
		<br>';		
		echo '<div style="line-height:1; font-family:times; color:black; text-align:center; font-size:23pt"><b>'.$rstudent['title'].'</b></div>
		<br>
		<br>
		<br>
		<br>
		<br>';
		echo '<div style="line-height:1; font-family:times; color:black; text-align:center; font-size:18pt">
		<img src="yuliana.png" style="height: 15mm;" >
		<br>
		<b><u>Ms Yuliana Pusptasari</u></b>
		</div>';
		echo '<div style="line-height:1; font-family:times; color:black; text-align:center; font-size:18pt"><b>Superitendent, Academic Supervision Division</b></div>';
