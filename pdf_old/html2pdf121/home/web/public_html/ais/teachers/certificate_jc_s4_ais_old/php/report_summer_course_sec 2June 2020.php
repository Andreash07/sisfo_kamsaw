...
if($rows==0){
	...
	if($i<10){
		...
		//$nroom=$r['Class_Name'];
			echo '<page orientation="paysage">
	<div  style="padding-top:155mm;  background-image: url(Certificate.jpg);  background-size: contain;">
	<div style="margin: auto;">
		<br>
	  ...
	  ';
		...
		echo '<div style="margin-top:-220pt;"><div style="line-height:0.5; font-family:aparabi; font-style:italic; color:black; text-align:left;margin-left:237pt; font-size:43pt"><b>'.$rstudent['student'].'</b></div>
		 <br>';
		echo '<div style="line-height:0.9; font-family:times; color:black; text-align:left;margin-left:237pt; font-size:10pt"><b>HAS SUCCESSFULLY COMPLETED 10 HOURS OF</b></div>
		<br>';
		...
		<br>
		<div style="line-height:1; font-family:times; color:black; text-align:left;margin-left:237pt; font-size:10pt"><b>HELD FROM 2 June 2020 TO 12 June 2020.</b> </div>	
		</div>	
		<br> 	
		<br>
		<br>
