...
if($rows==0){
	...
	if($i<10){
		...
		//$nroom=$r['Class_Name'];
		echo '<page orientation="paysage">
		<div  style="padding-top:147.5mm;  background-image: url(Certificate3.jpg);  background-size: contain;">
		<div style="margin: auto;">
		<br>
		...
		<div style="line-height:0.9; font-family:times; color:black; text-align:left;margin-left:237pt; font-size:10pt"><b>
		Is awarded to
		</b></div>
		<br>
		<div style="line-height:0.5; font-family:aparabi; font-style:italic; color:black; text-align:left;margin-left:237pt; font-size:43pt"><b>'.$rstudent['student'].'</b></div>
		 <br>';
		echo '<div style="line-height:0.9; font-family:times; color:black; text-align:left;margin-left:237pt; font-size:10pt"><b>
		for participating in the 1st Bina Bangsa School E-Learning Festival.
		</b></div>
		<br>';
		...
		<br>
		<div style="line-height:1; font-family:times; color:black; text-align:left;margin-left:237pt; font-size:10pt"><b>Held on 2 - 12 June 2020.</b> </div>	
		</div>	
		<br> 	
		<br>
		<br>
