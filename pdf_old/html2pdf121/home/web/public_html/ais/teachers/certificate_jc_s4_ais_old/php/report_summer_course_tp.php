...
from summer_courses_pic_pri A
left join summer_courses_pri G on (G.id = A.summer_courses_id)
...
if($rows==0){
	...
	if($i<10){
		...
		//$nroom=$r['Class_Name'];
		echo '<page orientation="paysage">
		<div  style="padding-top:150.5mm;  background-image: url(Certificate_t.jpg);  background-size: contain;">
		<div style="margin: auto;">
		<br>
