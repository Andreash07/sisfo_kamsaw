...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		// set bacground image
		$img_file = K_PATH_IMAGES.'pic/cover01.jpg';
		$this->Image($img_file, 0, 0, 178, 250, '', '', '', false, 300, '', false, false, 0);
...
$pdf = new MYPDF('P', PDF_UNIT, 'B5', true, 'UTF-8', false);

// set document information
$pdf->SetCreator(PDF_CREATOR);
$pdf->SetAuthor('Nicola Asuni');
$pdf->SetTitle('Preschool Report Cover');
$pdf->SetSubject('Report Cover');
...
*/
//<img src="'.$filefound.'" style="width:60px;height:75px;">
//pp_default.jpg
...
<td style="width:23mm;">&nbsp;</td>
 <td    align="center" style="text-align:center;vertical-align:bottom;width:84mm;" >&nbsp;</td>
 </tr>
  <tr>
<td style="width:23mm;">&nbsp;</td>
 <td    align="center" style="text-align:center;vertical-align:bottom;width:84mm;" >&nbsp;</td>
...
<tr>
<td style="width:23mm;">&nbsp;</td>
<td    align="center" style="text-align:center;vertical-align:bottom;width:84mm;" >
<p  color="darkblue" style="font-family:fantasy;font-weight:bold;font-size:14pt;"><br>'.$name.' </p>
</td>
</tr>
</table>
';

$html .= '<span style="font-family:fantasy;font-weight:bold;font-size:12pt;color:darkblue;" > '.$dob.'</span>';
