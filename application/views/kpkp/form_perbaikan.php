<div class="row">
  <div class="col-xs-12">
    <form class="form-horizontal form-label-left input_mask" action="<?=base_url();?>Data_Blok_Makam/submit_perbaikan?id=<?=$recid;?>" method="POST" id="form_perbaikan">
      <?php
      ...
      ?>
        <div class="form-group">
          ...
          <div class="col-md-9 col-sm-9 col-xs-12">
            <input type="date" class="form-control" placeholder="Tanggal" name="tgl_bayar" id="tanggal_edit" value="<?=  $value->tgl_bayar ;?>">
          </div>
        </div>
        <div class="form-group">
