...
<div class="container-fluid mt-4" style="min-height: 600px; position: relative;">
	...
	<div class="row align-items-center">
	  ...
	  <div class="col-12 text-center" style="margin: auto;">
	  	...
	  	<select id="hasil_wil" class="form-control col-8" style="float: right; clear: both; margin-top:-15px;">
	  		<option value="">Pilih Wilayah</option>
	  		<option value="1" <?php if($this->input->get('wil')==1){ echo "selected";} ?>>Wil 1</option>
	  		<option value="2" <?php if($this->input->get('wil')==2){ echo "selected";} ?>>Wil 2</option>
	  		<option value="3" <?php if($this->input->get('wil')==3){ echo "selected";} ?>>Wil 3</option>
	  		<option value="4" <?php if($this->input->get('wil')==4){ echo "selected";} ?>>Wil 4</option>
	  		<option value="5" <?php if($this->input->get('wil')==5){ echo "selected";} ?>>Wil 5</option>
	  		<option value="6" <?php if($this->input->get('wil')==6){ echo "selected";} ?>>Wil 6</option>
	  		<option value="7" <?php if($this->input->get('wil')==7){ echo "selected";} ?>>Wil 7</option>
	  	</select>
	  ...
	  <div class="col-12" style="margin: auto;">
	  	...
	  	<a href="<?=base_url();?>pnppj/perolehansuarapemilu1?wil=<?=$kwg_wil?>" class="btn btn-sm btn-icon btn-danger float-right" title="Hasil Perolehan Suara Sementar"><span class="btn-inner--icon"><i class="fa fa-refresh  fa-spin fa-fw" style="top:unset;"></i></span></a>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		setTimeout(function(){
			...
			$('#lbl_indeks').html('<?=$total_voted;?>/<?=$max_suara_masuk;?> (<b class="text-danger"><?= round($index_voted,2);?>% </b>)')
	...
	$(document).on('change', '#hasil_wil', function(e){
		...
		window.location.href = "<?=base_url();?>pnppj/perolehansuarapemilu1"+wil;
	})
