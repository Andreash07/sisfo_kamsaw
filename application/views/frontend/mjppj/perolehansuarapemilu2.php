...
<div class="container-fluid mt-4" style="min-height: 600px;">
	...
	<div class="row align-items-center" style="position: relative;">
	  ...
	  <div class="col-12 text-center" style="margin: auto;">
	    ...
	    <h2>Perolehan Suara<br>Penatua Tahap 2</h2>

	  </div>

	  <div class="col-12" style="margin: auto;">
	  	<span class="small" style="display:block;"><b>Peserta Pemilihan</b>: <?=$NumAngjem;?> ( @ 8 Hak Suara)</span>
	  	...
	  	<a href="<?=base_url();?>pnppj/perolehansuarapemilu2" class="btn btn-sm btn-icon btn-danger float-right" title="Hasil Perolehan Suara Sementar"><span class="btn-inner--icon"><i class="fa fa-refresh  fa-spin fa-fw" style="top:unset;"></i></span></a>
				...
				<tbody>
			        ...
			        $foto_thumb=base_url().'assets/images/default-user.png';
					    ...
					    if($valuevoted->foto != null){
							...
							$lock='<i class="fa fa-times text-danger"></i>Tidak Terpilih';
							if($valuevoted->status_terpilih==1){
								$lock='<i class="fa fa-check-square text-success"></i> Terpilih';
					...
					<?php
						...
						<tr>
							...
							<th class="text-center" colspan="4">Belum ada suara Sah yang Masuk</th>
						...
						$index_voted=$total_voted/($NumAngjem*8)*100;
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		setTimeout(function(){
			...
			$('#lbl_indeks').html('<?=$total_voted;?>/<?=$NumAngjem*8;?> (<b class="text-danger"><?= round($index_voted,2);?>% </b>)')
