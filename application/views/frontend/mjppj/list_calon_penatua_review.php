<div class="modal-header">
  ...
  <h6 class="modal-title" id="modal-title-default">List Calon Penatua - <b style="">Wil. <?=$wil_pemilih;?></b></h6>
...
<div class="modal-body" style="padding-top: unset; border-top: 1px #ededed solid;">
  <div class="clearfix"></div>
   <label class="text-muteds ">Setiap Peserta Pemilihan memilih <b id="hak_suara"><?=$hak_suara;?> Calon Penatua</b>
    <br>
    (<b id="hak_suara_wanita"><?=$hak_suara_wanita;?></b><b> Perempuan </b> dan <b id="hak_suara_pria"><?=$hak_suara_pria;?></b><b> Laki-laki</b>)
  </label>

  <span class="text-danger h5">Daftar Calon Penatua Tahap 1 akan dapat Anda pilih saat <b>Proses Pemilihan Dibuka</b></span>
  <div class="clearfix"></div>
