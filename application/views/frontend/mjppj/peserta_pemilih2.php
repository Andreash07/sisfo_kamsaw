        ...
        <div class="card card-stats">
          ...
          <div class="card-body">
            ...
            <p class="mt-3 mb-0 text-sm">
              ...
              <a id="btn_ajax_modal" href="<?=base_url();?>ajax/list_calon_penatua2/?kwg_wil=<?=$value->kwg_wil;?>&id=<?=$value->id;?>&nama=<?=rawurlencode($title.ucwords($value->nama_lengkap));?>" class="col-12 btn btn-info btn-sm text-nowrap float-left" data-toggle="modal" data-target="#exampleModal" onclick="event.preventDefault();"><i class="ni ni-bullet-list-67"></i><b>Penatua</b></a>
            </p>
          </div>
        </div>
      </div>
