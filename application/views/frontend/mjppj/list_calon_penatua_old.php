...
<div class="modal-body" style="padding-top: unset; border-top: 1px #ededed solid;">
  ...
  <label class="text-muted">Anda sudah memilih <b id="lbl_num_pilihan">0</b> dari <b id="hak_suara"><?=$hak_suara;?></b>
    <br>
  ...
  <form id="form_pemilihan" action="<?=base_url();?>pnppj/submit_pemilihan">
   ...
   <!--<div id="div_button" class="row">
      <div id="btn_filter" class="btn btn-primary btn-sm col-5" value="Laki-laki"><i class="fa fa-male" style="font-size:12pt;"></i> Laki-laki</div>
      <div class="col-1"></div>
      <div id="btn_filter" class="btn btn-danger btn-sm  col-5" value="Perempuan"><i class="fa fa-female" style="font-size:12pt;"></i> Perempuan</div>
      <input id="filter_active" name="filter_active" type="hidden">
    </div>-->
    ...
    <table id="tbl_calon_penatua" class="table table-striped">
      ...
      ?>
        ...
        <tr>
          ...
          <td style="font-size:12px;" recid="<?=$value->id;?>" id="col_nama_calon">
