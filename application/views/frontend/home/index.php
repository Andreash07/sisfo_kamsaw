        ...
        <div class="col-12">
          ...
          <div class="card card-stats">
            ...
            <div class="card-body" style="padding:unset; position:relative;">
                <img src="<?=base_url();?>/assets/images/poster-mobile-pnt-01_compressed2630.jpeg" class="img-fluid" instyle="border-bottom-left-radius: .375rem;border-bottom-right-radius: .375rem;"> 
                <?php 
