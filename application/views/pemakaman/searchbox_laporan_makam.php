<form class="form-horizontal form-label-left" action="" method="GET">
    ...
    <div class="form-group col-xs-12">
      ...
      <a class="btn btn-warning pull-left" href="<?=base_url();?>pemakaman/laporan_iuran_makam/?<?=$_SERVER['QUERY_STRING'];?>&export=print" target="_BLANK"><i class="fa fa-print"></i> Print</a>
