...
?>
Jumlah Peserta <b><?=count($angjem);?></b>
<br>
Jumlah Peserta Sudah Menggunakan Hak Suaranya <b><?= count($sudah_vote_online)+count($sudah_vote_offline);?></b> (Online: <?=count($sudah_vote_online);?> + Konvensional: <?=count($sudah_vote_offline);?>)
<br>
Jumlah Peserta Belum Kunci Suaranya <b id="tidaksah">0</b>
<br>
Jumlah Peserta Belum Menggunakan Hak Suaranya <b id="golput">0</b> (Termasuk Konvensional: <b id="konvensional">0</b>)
<br>
<br>
