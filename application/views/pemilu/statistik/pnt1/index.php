...
<div class="right_col" role="main">
	<div class="row">
  	<h2 class="col-md-7 col-sm-7 col-xs-12">Statistik Perolehan Suara - Penatua I</h2>
		...
		<div class="col-md-7 col-sm-12 col-xs-12">
	      	...
	      	<div class="x_panel tile">
	            ...
	            <div class="x_title">
	              	...
	              	<h2>Suara Pemilihan Penatua I - Wilayah</h2>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var num_pesertaPemilihan_dikunci
		...
		$.post('<?=base_url();?>ajax/statistik_pnt1_wil', dataMap, function(data){
    		...
    		for(var l in json.pesertaPemilihan_dikunci)
//console.log(json.pesertaPemilihan_dikunci[l]+' asd'+l)
    			num_pesertaPemilihan_dikunci=json.pesertaPemilihan_dikunci;

    		for(var m in json.pesertaPemilihan_belumkunci)
    			//console.log(json.pesertaPemilihan_belumkunci[m]+' asdhh'+m)
    			num_pesertaPemilihan_belumkunci=json.pesertaPemilihan_belumkunci;
			...
			if ($('#mainb').length ){
			  	...
			  	echartBar.setOption({
					...
					legend: {
					  ...
					  data: ['Total Suara', 'Suara Sah', 'Suara Belum Dikunci']
