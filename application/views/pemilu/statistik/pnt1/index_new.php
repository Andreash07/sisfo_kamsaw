...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$.post('<?=base_url();?>ajax/statistik_pnt1_wil_new', dataMap, function(data){
			...
			for(var i in json.num_pesertaPemilihan)
    			...
    			peserta_pemilihan.push(json.num_pesertaPemilihan[i]*1);
			...
			pieChart('echart_pie_global', json.num_pesertaPemilihan_global*1, json.num_suaraDikunci_global, json.num_BelumDikunci_global, 'Perolehan Suara Total')
			...
			if ($('#mainb').length ){
			  	...
			  	echartBar.setOption({
					...
					legend: {
					  ...
					  data: ['Total Suara', 'Suara Sah', 'Suara Tidak Sah']
			...
			if ($('#'+dom).length ){  
			  ...
			  echartPie.setOption({
			  	...
			  	title: {
					  ...
					  subtext: 'Total Suara '+peserta+' (x8 @1Peserta)'
