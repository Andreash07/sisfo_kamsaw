	...
	?>
		<tr>
			...
			<td style=" vertical-align: middle;">
				<img src="<?=$foto_thumb;?>" data-caption="<?=$title.$valuevoted->nama_lengkap;?>" alt="<?=$title.$valuevoted->nama_lengkap;?>" class="img-circle img-responsive" style="width: 77px;height: 77px;object-fit: cover; cursor: pointer; margin-right: 10px; display: inline;" href="<?=$foto;?>" data-fancybox="images" data-caption="<?=$title.$valuevoted->nama_lengkap;?>"> <?=$title.$valuevoted->nama_lengkap;?></td>
		        ...
		        <div class="modal-dialog modal-sm">
		          	<div class="modal-content">
			            <div class="modal-header">
			              ...
			              <h4 class="modal-title" id="myModalLabel2"><?=$title.$valuevoted->nama_lengkap;?></h4>
			            </div>
