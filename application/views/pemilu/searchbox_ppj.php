    ...
    <div class="form-group col-md-6 col-xs-12">
      ...
      <div class="col-md-9 col-sm-9 col-xs-12">
          <select class="form-control" id="status_pn1" name="status_pn1" >
            <option value='' >Semua</option>
            <option value='1' <?php if($this->input->get('status_pn1')=='1'){echo "selected";}?>>Diterima</option>
            <option value='-1' <?php if($this->input->get('status_pn1')=='-1'){echo "selected";}?>>Dibatalkan</option>
          </select>
      </div>
    </div>
